...
const VideoTitle = ({ title, overview, movieId, description }) => {
	...
	useEffect(() => {
		let exitFullScreenButton = document.querySelector(
	...
	return (
		<div className="video-title pt-[32%] h-full xl:pt-[9%] absolute top-0 w-screen aspect-video px-2 md:px-[20px] text-white bg-gradient-to-t from-zinc-950 to-15%">
			<div className="absolute top-0 left-0 h-full w-full"></div>
			<div className="absolute z-1">
				<h1 className="text-[2=14px] xl:text-6xl font-bold w-1/2 md:w-1/4">
					{title}
				</h1>
